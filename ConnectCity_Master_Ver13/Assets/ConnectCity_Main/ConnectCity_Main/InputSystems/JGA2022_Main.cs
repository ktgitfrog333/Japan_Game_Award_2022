...
//     version 1.2.0
//     from Assets/ConnectCity_Main/ConnectCity_Main/InputSystems/JGA2022_Main.inputactions
//
...
public partial class @JGA2022_Main : IInputActionCollection2, IDisposable
{
    ...
    {
        private @JGA2022_Main m_Wrapper;
        public PlayerActions(@JGA2022_Main wrapper) { m_Wrapper = wrapper; }
    ...
    {
        private @JGA2022_Main m_Wrapper;
        public UIActions(@JGA2022_Main wrapper) { m_Wrapper = wrapper; }
    ...
    {
        private @JGA2022_Main m_Wrapper;
        public SpaceActions(@JGA2022_Main wrapper) { m_Wrapper = wrapper; }
